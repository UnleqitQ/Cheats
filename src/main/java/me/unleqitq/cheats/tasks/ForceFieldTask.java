						...
						if (entity.getLocation().distance(p.getLocation()) <= dist) {
							if (!(entity instanceof Projectile)) {
								if (entity instanceof LivingEntity) {
									CraftLivingEntity e = (CraftLivingEntity) entity;
									Vector vel = e.getVelocity();
									Vector d = e.getLocation().toVector().subtract(p.getLocation().toVector());
